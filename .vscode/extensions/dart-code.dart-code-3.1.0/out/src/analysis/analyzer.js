...
class AnalyzerCapabilities {
    ...
    get supportsFlutterOutline() { return utils_2.versionIsAtLeast(this.version, "1.26.0"); }
    ...
    get supportsAvailableSuggestions() { return utils_2.versionIsAtLeast(this.version, "1.26.0"); }
}
...
class Analyzer extends analyzer_gen_1.AnalyzerGen {
    constructor(dartVMPath, analyzerPath) {
        ...
        if (config_1.config.analyzerObservatoryPort)
            analyzerArgs.push(`--enable-vm-service=${config_1.config.analyzerObservatoryPort}`);
