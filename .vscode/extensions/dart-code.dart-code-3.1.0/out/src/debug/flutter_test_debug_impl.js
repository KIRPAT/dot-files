...
class FlutterTestDebugSession extends dart_test_debug_impl_1.DartTestDebugSession {
    spawnProcess(args) {
        ...
        return this.createRunner(args.flutterPath, args.cwd, args.program, processes_1.globalFlutterArgs.concat(["test", "--machine"]).concat(appArgs), args.env, args.flutterTestLogFile, logger, args.maxLogLineLength);
    }
}
