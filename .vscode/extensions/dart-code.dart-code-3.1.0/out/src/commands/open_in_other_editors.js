...
class OpenInOtherEditorCommands {
    ...
    openInAndroidStudio(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (utils_1.isMac && androidStudioDir.endsWith("/Contents")) {
                ...
                processes_1.safeSpawn(folder, "open", ["-a", androidStudioDir, folder]);
            }
            else {
                processes_1.safeSpawn(folder, path.join(androidStudioDir, utils_2.androidStudioPath), [folder]);
            }
        });
    }
    openInXcode(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            processes_1.safeSpawn(folder, "open", ["-a", "Xcode", file]);
        });
    }
    getAndroidStudioDir(folder) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const proc = processes_1.safeSpawn(folder, binPath, ["config", "--machine"]);
            const output = [];
