    ...
    jumpToLineColInUri(uri, lineNumber, columnNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lineNumber && columnNumber) {
                ...
                editor_1.showCode(editor, line.range, line.range, new vs.Range(firstChar, firstChar));
            }
        });
    }
