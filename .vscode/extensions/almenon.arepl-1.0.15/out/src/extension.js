...
function activate(context) {
    ...
    registerAreplDump_1.registerAreplDump(previewManager.getPythonPath(), context.extensionPath);
}
exports.activate = activate;
// This method is called when extension is deactivated
function deactivate() {
    registerAreplDump_1.unregisterAreplDump(previewManager.getPythonPath());
}
